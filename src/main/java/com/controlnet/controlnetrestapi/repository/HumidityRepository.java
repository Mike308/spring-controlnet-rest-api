...
public interface HumidityRepository extends CrudRepository <HumidityView, Integer> {
    ...
    @Query(value = "select v_humidity.id, name, humidity, date, v_humidity.sensor_type from v_humidity  \n" +
            "  join sensors on sensors.id = v_humidity.id\n" +
